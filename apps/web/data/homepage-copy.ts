...
export const homepageCopy: HomePageCopy = {
	header: {
		...
		variants: {
			default: {
				...
				description:
					"Nubesti Recorder is a powerful screen recording tool. Lightweight, powerful, and cross-platform. Record and share securely in seconds with custom S3 bucket support. Connect your own domain.",
			},
		},
		cta: {
			primaryButton: "Upgrade to Nubesti Pro",
	...
	features: {
		...
		features: [
			...
			{
				title: "Speed up your workflow with Nubesti AI",
				description:
	...
	faq: {
		...
		items: [
			{
				question: "What is the difference between Nubesti Pro and Desktop License?",
				answer:
					"Nubesti Pro is a paid plan that includes all the features of the Desktop License plus cloud features for seamless sharing and collaboration. Desktop License grants you commercial usage rights for a single user.",
			},
			{
				question: "Is there a free version?",
				answer:
					"Yes! Nubesti Recorder is 100% free for personal use. You can record and share locally with Studio Mode. A paid plan is required for commercial usage.",
			},
			{
			...
			{
				question: "How does Nubesti AI work?",
				answer:
					"Nubesti AI is a powerful tool that can be used to generate titles, summaries, clickable chapters, and transcriptions for your recordings. It's available for all Nubesti Pro users and has no usage limits.",
			},
			{
			...
			},
			{
				...
				answer:
					"Yes! Nubesti Pro includes team workspaces where you can organize recordings, manage permissions, and collaborate. Volume discounts available for teams over 10 users. Contact us for custom enterprise features.",
			},
			{
			...
			{
				question: "Can I use Nubesti Recorder for commercial purposes?",
				answer:
					"Absolutely! Any paid plan (Desktop License or Nubesti Pro) includes full commercial usage rights. Use Nubesti Recorder for client work, sell courses, or embed recordings anywhere. The free version is for personal use only.",
			},
			{
				question: "Is my data secure?",
				answer:
					"Security is core to Nubesti Recorder. Our code is fully auditable and transparent - you can see exactly how your data is handled. End-to-end encryption for cloud storage, option to use your own infrastructure, and community-driven security reviews keep your content safe.",
			},
			{
				question: "What about GDPR/HIPAA compliance?",
				answer:
					"Nubesti Pro supports custom S3 buckets in any region for GDPR compliance. For HIPAA and other regulations, our self-hosted option gives you complete control. We also offer signed BAAs for enterprise customers.",
			},
		],
	},
	readyToGetStarted: {
		...
		buttons: {
			primary: "Upgrade to Nubesti Pro",
